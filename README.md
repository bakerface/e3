...
### e3_timer_create
This function creates a timer that schedules a function to be called after the specified time (in clock ticks). *Please note that these are one-shot timers, which will be deleted automatically after they expire. To reschedule a timer, re-create the timer from within the timer function.*

| Parameter                    | Description                                 |
|:----------------------------:|:--------------------------------------------|
| e3_timer_t *timer            | The timer to create                         |
| e3_timer_ticks_t ticks       | The number of ticks until the timer expires |
